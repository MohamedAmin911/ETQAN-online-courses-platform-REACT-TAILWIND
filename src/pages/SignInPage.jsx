          ...
          <div className="relative z-10 flex w-full flex-col items-center justify-center px-20 text-center">
            <div className="relative mb-12 w-full max-w-lg">
              ...
              <img
                ...
                className="relative z-20 h-auto w-full rounded-xl shadow-2xl transition-transform duration-700 hover:rotate-0 scale-110 -rotate-3"
            ...
            <div className="glass-panel mt-16 max-w-sm self-end rounded-xl border border-white/20 p-6 text-right">
              <p className="mb-4 font-medium italic leading-relaxed text-on-surface">
                &quot;لقد غيرت هذه المنصة نظرتي للتعليم الرقمي، التصميم مريح جداً
                والمحتوى يفوق التوقعات.&quot;
              </p>

              <div className="flex items-center gap-3">
                <div className="h-10 w-10 overflow-hidden rounded-full bg-surface-dim">
                  <img
                    alt="User avatar"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuD8Vp5lmLFelNqx49BEW3oCoR1weIT54gZkt6EHm0rTRzxbkY-F6uTJnvccsL2Isv2ln5spRoskkYEs_rZZVsTlRxn6j67aQDtNGbrU5ZKrpoCaE3pL4FlhB9e2-mVKxHSc3oafOFGcADopGb8HlO8nzf6anWSsevES6V0_qnzlNLuHsSTtM2faal4J5cTix4KMv-x8zUucIGgPc7XP7LHfAQZThGtAPcHCylvU3rhwR8zxZNITSfmOKA1yKUmuiq-qzhxB0cklG3ph"
                  />
                </div>

                <div>
                  <p className="text-sm font-bold text-primary">أحمد العبدالله</p>
            ...
            <div className="w-full max-w-md">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="group relative">
                  <input
                    className="peer w-full rounded-xl border-none bg-surface-container-high px-5 py-4 text-on-surface placeholder-transparent transition-all duration-300 focus:ring-4 focus:ring-primary/10"
                    id="email"
                    name="email"
                    placeholder=" "
                    type="email"
