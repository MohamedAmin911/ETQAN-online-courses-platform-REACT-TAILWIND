          ...
          <main className="pt-20 flex flex-row h-screen overflow-hidden">
            ...
            <section className="flex-1 overflow-y-auto bg-surface pb-12">
              ...
              <div className="p-8 max-w-6xl mx-auto">
                ...
                {/* Instructor Section */}
                <div className="mt-12 p-8 bg-gradient-to-br from-primary-container to-primary rounded-3xl text-on-primary flex flex-row-reverse items-center gap-8 shadow-xl">
