      ...
      <div>
        <aside className="fixed right-0 top-0 z-40 hidden h-full w-64 flex-col border-l border-surface-container bg-surface-container-lowest shadow-[0px_12px_32px_rgba(28,25,45,0.06)] md:flex">
          <div className="px-8 py-10">
            <h1 className="font-headline text-2xl font-bold bg-linear-to-r from-violet-700 to-fuchsia-600 bg-clip-text text-transparent">
          ...
          <div className="mx-auto max-w-7xl space-y-8 p-6">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    {enrolledCourses.map((course) => (
                      <div
                        key={course.id}
                        className="rounded-2xl bg-surface-container-lowest p-5 shadow-[0px_12px_32px_rgba(28,25,45,0.06)] transition-transform duration-300 hover:-translate-y-1"
                      >
            ...
            <footer className="mt-12 bg-surface-container-low px-8 py-10">
              ...
              <div className="mt-10 border-t border-surface-variant pt-6 text-center">
                <p className="text-xs text-on-surface-variant">© 2026 ETQAN. جميع الحقوق محفوظة.</p>
              </div>
            </footer>
          </div>
